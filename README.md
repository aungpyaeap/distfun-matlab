...
|----------|----------|----------|----------|----------|----------|
| Euclidean distance         |$d(x_i,x_j) = \| x_i - x_j\|_2 =  \sqrt{\sum_{k=1}^m (x_{ik} - x_{jk})^2}$| Numerical          | $[0, +\infty\rangle$ | $d$ | [2][7]|
| Squared Euclidean distance |$d(x_i,x_j) = \sum_{k=1}^m (x_{ik} - x_{jk})^2$| Numerical          | $[0, +\infty\rangle$ | $d$ | [2][7]|
| City block distance        |$d(x_i,x_j) = \| x_i - x_j\|_1 =  \sum_{k=1}^m \vert x_{ik} - x_{jk}\vert$| Numerical          | $[0, +\infty\rangle$ | $d$ | [2][7]|
| Chebyshev distance         |$d(x_i,x_j) = \| x_i - x_j\|_4 =  \max_{k=1}^m \vert x_{ik} - x_{jk}\vert$| Numerical          | $[0, +\infty\rangle$ | $d$ | [2][7]|

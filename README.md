...
- Euclidean distance: $d(x_i,x_j) = \|x_i -  x_j\|_2  = \sqrt{\sum_{k=1}^m (x_{ik} - x_{jk})^2}$
- City block distance: $d(x_i,x_j) = \|x_i -  x_j\|_1 = \sum_{k=1}^{m} |x_{ik} - x_{jk}|$
- Chebyshev distance: $ d(x_i,x_j) = \|x_i -  x_j\|_4 = \max_{k=1}^{m} |x_{ik} - x_{jk}|$
